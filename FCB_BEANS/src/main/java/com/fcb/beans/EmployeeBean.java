...
public class EmployeeBean implements Serializable {
	...
	public String toString() {
		return "EmployeeBean [employeeId=" + employeeId + ", firstName=" + firstName + ", lastName=" + lastName
				+ ", dob=" + dob + ", gender=" + gender + ", email=" + email + ", mobile=" + mobile + ", bloodGroup="
				+ bloodGroup + ", joiningDate=" + joiningDate + ", desgination=" + desgination + ", salary=" + salary
				+ ", branchId=" + branchId + ", status=" + status + ", createdBy=" + createdBy + ", createdDate="
				+ createdDate + "]";
	}
